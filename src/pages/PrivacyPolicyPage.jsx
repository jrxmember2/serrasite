...
// Página jurídica: sem faixa fotográfica, sem animação de título, sem CTA de
// venda. Quem chega aqui veio ler, e na maioria das vezes veio de fora do site
// — da ficha do app na Google Play ou de um contrato.
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
      <Seo path="/legal/politica-de-privacidade" />
      ...
      <section className="section legal-page">
        <div className="container">
          ...
          <div className="legal-body">
            {/* O índice é lateral no desktop e vira uma lista no topo do texto
                no mobile — a política é longa demais para se rolar às cegas. */}
